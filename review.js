...
let text1="Sabrina"
let letter1=text1.charAt(4)
console.log(letter1)
// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy
let text2="Teddy"
let code=text2.charCodeAt(3)
console.log(code)
// Using fromCharCode() - make it readable for us :). You'll see!
let char=String.fromCharCode(100)
console.log(char)
...
const str_1='Join our party now'
console.log(str_1.startsWith('Join'))
// Now use any variable with endsWith() and return false
console.log(str_1.endsWith('Now'))
...
console.log(jahlunSaidToPutSomeRespectToHisName.substring(1,3))

// Returns "ell"
const basicGreeting = "Hello World"
console.log(basicGreeting.slice(1,4))
...
let text="        If only I can use this for my love handles"
...
for(let i=0;i<Object.keys(whateverQueenBeySaid);i++){
  console.log(whateverQueenBeySaid[i]);
}

// Using (FOR IN LOOP), print the indexes of the array.
const lana = ['l', 'a', 'n', 'a']
for(let i=0;i<lana.length;i++){
  console.log(i);
}

// USE (FOR OF LOOP)!
const tia = ['teo', 'the', 'syntax', 'of', 'this', 'is', 'cleaner']
for(let i=0;i<tia.length;i++){
  console.log(i);
}
...
for(let i=0;i<perscholas.length;i++){
  let str=" PS"
  console.log(perscholas[i].concat(str))
}
...
fruits.splice(0,1,"lemon","grapefruit")
console.log(fruits)
...
const exoticFruits = ['coconut', 'avocado','pineapple']
console.log(fruits.concat(exoticFruits))

// Print the last two exotic fruits without altering the newly concatenated array.
console.log(exoticFruits.splice(1,2))
...
// const filtered = RafaelNoBadWords.filter((item) => item!=="badword")
...
const sum=numbersToAddUp.reduce((partialSum, a) => partialSum + a, 0);
console.log(sum)
// ===== SPREAD OPERATOR ===== 
...
const fewFruit = ['apple','pear','peach']
const fewMoreFruit = ['pineapple', 'orange', ...fewFruit]
...
const Fruit = ['apple','pear','peach']
const MoreFruit = [...fewFruit,'pineapple', 'orange']
...
let human={name:"John Doe", age:50, location:"New York"}
...
// Print cut
console.log(overgrow.moves[2])

// Print Bulbahhhh!!!!!
console.log(overgrow.sound)
...
var prop = bulbasaur.map(function(i) {
  return i.prop;
});